...
while cap.isOpened():
    ...
    if results.pose_landmarks:
        ...
        frame_height = frame.shape[0]        # Calculate shirt width based on shoulder width with increased scaling
        shoulder_distance = abs(left_shoulder.x - right_shoulder.x)
        shirt_width = int(shoulder_distance * frame_width * 1.4)  # Increased from 1.2
        ...
        shirt_height = int(torso_height * 1.3)  # Increased from 1.1
