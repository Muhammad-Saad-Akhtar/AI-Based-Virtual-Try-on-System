...
while cap.isOpened():
    ...
    if results.pose_landmarks:
        ...
        frame_height = frame.shape[0]        # Calculate shirt width based on shoulder width with increased scaling        shoulder_distance = abs(left_shoulder.x - right_shoulder.x)
        shirt_width = int(shoulder_distance * frame_width * 1.6)  # Increased from 1.4
        ...
        shirt_height = int(torso_height * 1.5)  # Increased from 1.3
