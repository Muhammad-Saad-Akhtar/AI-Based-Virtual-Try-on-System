...
class EdgeAwareLoss(nn.Module):  
    ...
    def forward(self, pred, edge_pred, target):
        ...
        # Compute Sobel edges for each image in the batch using kornia's separate x and y filters
        sobel_x = kf.sobel_x(target, normalized=True)
        sobel_y = kf.sobel_y(target, normalized=True)
